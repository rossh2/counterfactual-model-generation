...
sentEqualExceptPresupps (ParsedConditional p1 q1 timeC1 tree1) (Just (ParsedConditional p2 q2 timeC2 tree2)) = equalExceptPresupps p1 p2 && equalExceptPresupps q1 q2 && timeC1 == timeC2
...
extractTemporalAdjuncts (Sent2 c tp1 tp2) = [] -- TODO lazy because not needed
...
showExceptTreeAndPresupps (ParsedConditional p q tc sentTree) = "ParsedConditional { antecedent = " ++ showPropExcept p ++ ", consequent = " ++ showPropExcept q ++ ", timeContrast = " ++ show tc ++ "}"
